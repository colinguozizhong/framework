...
$(function(){
  ...
  function showSubmitPage(){
          ...
          $.ajax({
				url: '<%=basePath%>sysRole/setRole.do?roleId=' + rows[0].roleId+'&menuIds='+menuIds,
				success:function(){
...
<div id="dlg" class="easyui-dialog" closed="true" title="角色窗口" style="width:400px;height:360px;padding:10px"data-options="buttons: '#dlg-buttons'">
		<div id="p" class="easyui-panel"  style="width:350px;height:260px;padding:10px;">
		   <form action="" id="addForm">
		   		<input type="hidden" name="roleId" id="roleId" />
		   		<input type="text" name="roleName" id="roleName" class="easyui-textbox" data-options="label:'角色名称：',required:true" style="width:230px"/><br /><br />
				<input type="text" name="roleCode" id="roleCode" class="easyui-textbox" data-options="label:'角色编码：',required:true" style="width:230px"/><br /><br />
				<input type="text" name="remark" id="remark" class="easyui-textbox" data-options="label:'角色说明：'" style="width:230px"/><br /><br />
				<select class="easyui-combobox" id="roleType" name="roleType" label="所属类别：" labelPosition="right" style="width:250px;">
									<option></option>
									<option value="0">系统管理</option>
									<option value="1">许可业务</option>
				...
				<select class="easyui-combobox" id="isSysRole" name="isSysRole" label="角色级别:" labelPosition="right" style="width:250px;">
									<option></option>
